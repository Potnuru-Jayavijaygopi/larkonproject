...
import { BsSearch,BsGearFill,BsImage, BsClockFill, BsMoonFill,BsBellFill } from 'react-icons/bs';
    ...
    <header className="top-header">
      ...
      <div className="d-flex align-items-center gap-3">
        ...
        <div className='rounded-4 bg-secondary bg-opacity-25 d-flex align-items-center justify-content-center flex-shrink-0' style={{width : 26,height : 26}}>
          <button className="header-icon-btn text-dark opacity-75" type="button" title="Image" style={{fontSize : 12}}>
          <BsImage />
        </button>
      </div>
