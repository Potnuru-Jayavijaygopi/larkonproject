...
function ProductTable({ onNavigate }) {
  const initialProducts = [
    ...
    },
    {
      ...
      sizes: "Size : 18 , 19 , 20 , 21",
      price: "$89.00",
      stockLeft: "321 Item Left",
      stockSold: "681 Sold",
      category: "Shoes",
      rating: "4.5",
      reviews: "321 Review",
    ...
    },
    {
      ...
      sizes: "Size : 40 , 41 , 42 , 43",
      price: "$222.00",
      stockLeft: "176 Item Left",
      stockSold: "658 Sold",
      category: "Shoes",
      rating: "4.1",
      reviews: "370 Review",
                ...
                <td>
                  <div className="d-flex align-items-center gap-3">
                    <div
                      ...
                      onClick={() =>
                        onNavigate && onNavigate("product-details")
                      }
                    >
                      <BsImage />
                    </div>
