          ...
          {openMenu === "products" && (
            <div className="submenu">
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "products", "/products/list")
                }
              >
                Product List Table
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "products", "/products/grid")
                }
              >
              ...
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "products", "/products/details")
                }
              >
                Product Details
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "products", "/products/add")
                }
              >
                Edit Product Form
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "products", "/products/create")
                }
              >
                Create Product Form
              </NavLink>
          ...
          {openMenu === "category" && (
            <div className="submenu">
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "category", "/category/list")
                }
              >
                Category List
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "category", "/category/edit")
                }
              >
                Edit Category
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "category", "/category/create")
                }
              >
                Create Category
              </NavLink>
          ...
          {openMenu === "inventory" && (
            <div className="submenu">
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "inventory", "/inventory/warehouse")
                }
              >
                Warehouse Inventory
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "inventory", "/inventory/received")
                }
              >
                Received Orders
              </NavLink>
          ...
          {openMenu === "orders" && (
            <div className="submenu">
              ...
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "orders", "/orders/details")
                }
              >
                Order Details
              </NavLink>
              ...
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "orders", "/orders/checkout")
                }
              >
                Order Checkout
              </NavLink>
          ...
          {openMenu === "purchases" && (
            <div className="submenu">
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "purchases", "/purchases/list")
                }
              >
                Purchase List
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "purchases", "/purchases/orders")
                }
              >
                Orders List
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "purchases", "/purchases/returns")
                }
              >
                Return Orders
              </NavLink>
          ...
          {openMenu === "attributes" && (
            <div className="submenu">
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "attributes", "/attributes/list")
                }
              >
                Attribute List
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "attributes", "/attributes/edit")
                }
              >
                Edit Attribute
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "attributes", "/attributes/create")
                }
              >
                Create Attribute
              </NavLink>
          ...
          {openMenu === "invoices" && (
            <div className="submenu">
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "invoices", "/invoices/list")
                }
              >
                Invoice List
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "invoices", "/invoices/details")
                }
              >
                Invoice Details
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "invoices", "/invoices/create")
                }
              >
                Create Invoice
              </NavLink>
          ...
          {openMenu === "pages" && (
            <div className="submenu">
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "pages", "/pages/coming-soon")
                }
              >
                Coming Soon
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "pages", "/pages/maintenance")
                }
              >
                Maintenance Page
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "pages", "/pages/error-404")
                }
              >
                Error 404 Page
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "pages", "/pages/timeline")
                }
              >
                Timeline
              </NavLink>
              <NavLink
                ...
                onClick={(e) =>
                  handleSubItemClick(e, "pages", "/pages/pricing")
                }
              >
                Pricing
              </NavLink>
            ...
            <div className="submenu">
              {[
                ...
                <NavLink
                  ...
                  onClick={(e) =>
                    handleSubItemClick(e, "baseUi", `/base-ui/${subItem.key}`)
                  }
                >
                  {subItem.name}
                </NavLink>
