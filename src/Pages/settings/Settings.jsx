...
function Settings({ onNavigate }) {
  ...
  useEffect(() => {
    ...
    ]).then(([genData, profData]) => {
      if (!isMounted) return;

      if (genData) {
        setMetaTitle(genData.meta_title || '');
        setMetaTagKeyword(genData.meta_keywords || '');
        setStoreTheme(genData.store_theme || 'Default');
        setLayout(genData.layout || 'Default');
        setDescription(genData.meta_description || '');
      }
  ...
  return (
    <div className="w-100">
      {statusMessage && (
        <div className={`alert ${statusMessage.success ? 'alert-success' : 'alert-danger'} alert-dismissible fade show mb-4`} role="alert">
          {statusMessage.text}
      ...
      <form onSubmit={handleSave}>
        ...
        <div className="content-card p-4 mb-4 shadow-sm">
          ...
          <div className="mb-3">
            <label htmlFor="addressTextarea" className="form-label text-muted small" style={{ fontSize: '0.75rem' }}>Full Address</label>
            <textarea
              id="addressTextarea"
              className="form-control form-control-sm"
              rows="3"
        ...
        <div className="row g-3 mb-4">
          ...
          <div className="col-lg-3 col-md-6">
            <div className="content-card p-4 shadow-sm">
              ...
              <div className="mb-2">
                <label htmlFor="minVouchersInput" className="form-label text-muted small" style={{ fontSize: '0.75rem' }}>Minimum Vouchers</label>
                <input
                  id="minVouchersInput"
                  type="text"
                  className="form-control form-control-sm"
              ...
              <div>
                <label htmlFor="maxVouchersInput" className="form-label text-muted small" style={{ fontSize: '0.75rem' }}>Maximum Vouchers</label>
                <input
                  id="maxVouchersInput"
                  type="text"
                  className="form-control form-control-sm"
