                            ...
                            return (
                                <div
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <span
                                            className={`font-[Play] ml-[12px] text-[14px] font-normal leading-[100%] text-[#5D7186] truncate max-w-[440px] ${isCompleted ? "line-through" : ""
                                                }`}
                            ...
                            <div className="flex items-center gap-[8px]">
                                ...
                                {Array.from({ length: totalPages }, (_, i) => i + 1).map(pageNo => (
                                    <button
                                        ...
                                        className={`w-[33px] h-[33px] !rounded-full flex items-center justify-center cursor-pointer font-['Play'] font-normal text-[14px] leading-[100%] transition-colors ${currentPage === pageNo
